...
interface DAOMembershipPageProps {
  address: string;
  hasVoted: boolean;
  isVoting: boolean;
  memberList: any[];
...
export function DAOMembershipPage({
  address,
  hasVoted,
  isVoting,
  memberList,
  ...
  tokenModule,
  voteModule,
}: DAOMembershipPageProps) {
  return (
    <Screen style={{ paddingBottom: "1rem" }}>
      {address && <NavBar walletAddress={shortenAddress(address)} />}
      <Container
        style={{
            ...
            text: (
              ...
              >
                <Image
                  ...
                  height={35}
                />
                {"Built by @JoshTsch | joshtsch.eth"}
              </div>
            ),
          },
        ]}
